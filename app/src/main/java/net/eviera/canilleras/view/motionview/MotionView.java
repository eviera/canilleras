package net.eviera.canilleras.view.motionview;
...
import net.eviera.canilleras.R;
import net.eviera.canilleras.view.motionview.entity.MotionEntity;
import net.eviera.canilleras.view.motionview.multitouch.MoveGestureDetector;
import net.eviera.canilleras.view.motionview.multitouch.RotateGestureDetector;
